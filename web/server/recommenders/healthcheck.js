...
const IMPROVEMENT_CARDS = {
  medical: {
    title: '🏥 加強醫療保障',
    products: ['富邦實支實付醫療險', '富邦終身醫療險', '富邦住院日額醫療附約'],
  ...
  life: {
    title: '🛡️ 補齊壽險保障',
    products: ['富邦安心好漾定期保險', '富邦新富享人生還本終身保險'],
  ...
  saving: {
    title: '🐷 儲蓄理財方案',
    products: ['富邦珍吉利增額終身壽險', '富邦月月吉利還本終身保險'],
